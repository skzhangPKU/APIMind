...
class PlayStore():
	...
	def _generate_play_store_url(self):
		...
		# return ("https://play.google.com/store/apps/details?id=" + str(self.__package_name) + "&hl=zh-cn")
	...
	def _fetch_description(self, soup):
		...
		# content_container = soup.find_all('div', {"class": "bABER","data-g-id":"description"})[0]
